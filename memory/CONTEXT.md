...
- Consider whether writer consent for `/publications` should become a separate signed writer event rather than buyer-posted explicit consent evidence.
